...
public class Constants {
    ...
    public static final String GET_ALL_LISTS = "post";
    public static final String GET_LIST_BY_USER = "user/{id}/post";
//    public static final String GET_LIST_BY_TAG = "tag/{id}/post";
